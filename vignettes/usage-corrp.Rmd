...
Based on the benchmark results, the performance when using 8 cores shows a clear improvement over using 2 cores, reducing the execution time significantly.  This confirms that enabling parallel processing can greatly enhance the efficiency of computations with large datasets.
